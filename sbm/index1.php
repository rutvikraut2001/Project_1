<?php
	...
	$query = "SELECT  `locationLatitude`, `locationLongitude` FROM `location_tab` "; //location_db in location-db
	...
	<body>
	    <nav>  
			<ul> 
				...
				<li><a href="index.html" style="color:black;"> <b> About </b></a></li>
                <li><a href="contact.html" style="color:black;"><b>Contact Us</b></a></li>
				<li><a href="index.html" style="color:black;"><b>Exit</b></a></li>
			</ul> 
		</nav>
