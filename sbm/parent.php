        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="form-container">
                    ...
                    <form id="LoginForm" action="par1.php" method="POST" autocomplete="on" >
                        <!-- <select id="type">
                        ...
                        <a href="parent.php">Forgot Password</a>
                    </form>

                    <form action="par2.php" method="POST" id="RegForm" autocomplete="off"> 
                        <!-- <select id="type">
                            <option value="select type">Select Type</option>
                            <option value="student">Student</option>
                            <option value="parent">Parent</option>
                        ...
                        <input type="text" name="wardname" required placeholder="Enter your Wards Name">
